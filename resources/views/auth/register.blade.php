            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="gender" required>
                                    @foreach(config('app.genders') as $gender)
                                        <option {!! old('gender') === $gender ? 'selected' : '' !!}>{{__($gender)}}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            <label for="firstname" class="col-md-4 col-form-label text-md-right required">{{ __('Firstname') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="lastname" class="col-md-4 col-form-label text-md-right required">{{ __('Lastname') }}</label>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="birthday" type="date" min='1900-01-01' max="{{\Carbon\Carbon::today()->subYears(18)->format('Y-m-d')}}" class="form-control @error('birthday') is-invalid @enderror" name="birthday" value="{{ old('birthday') }}" autocomplete="birthday">
